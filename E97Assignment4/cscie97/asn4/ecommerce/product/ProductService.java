...
import cscie97.asn4.ecommerce.product.Country.EXPORT_STATUS;
...
class ProductService implements IProductService {
	...
	public void addCountry(String countryCode, String countryName,String exportStatus,
			String GUID) throws ContentParameterException, InvalidAccessTokenException, AccessDeniedException {
		IAuthenticationService authService = AuthenticationServiceFactory.getAuthenticationService();
		authService.checkAccess(GUID, "create_country");
	...
	public void addDevice(String deviceId, String deviceName, String mfgName,
			String GUID)  throws ContentParameterException, InvalidAccessTokenException, AccessDeniedException{
		IAuthenticationService authService = AuthenticationServiceFactory.getAuthenticationService();
		authService.checkAccess(GUID, "create_device");
	...
	public void addContent(String contentId,String contentType, String contentName,
			...
			int contentSize,String GUID) throws ContentParameterException, InvalidAccessTokenException, AccessDeniedException{
		IAuthenticationService authService = AuthenticationServiceFactory.getAuthenticationService();
		authService.checkAccess(GUID, "create_product");
